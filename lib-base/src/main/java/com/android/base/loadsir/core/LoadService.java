package com.android.base.loadsir.core;
...
import com.android.base.loadsir.callback.SuccessCallback;
import com.android.base.loadsir.core.Convertor;
import com.android.base.loadsir.core.LoadLayout;
import com.android.base.loadsir.core.LoadSir;
import com.android.base.loadsir.core.TargetContext;
import com.android.base.loadsir.core.Transport;
...
public class LoadService<T> {
    private com.android.base.loadsir.core.LoadLayout loadLayout;
    private com.android.base.loadsir.core.Convertor<T> convertor;

    LoadService(Convertor<T> convertor, TargetContext targetContext, Callback.OnReloadListener onReloadListener,
                com.android.base.loadsir.core.LoadSir.Builder builder) {
        ...
        loadLayout = new com.android.base.loadsir.core.LoadLayout(context, onReloadListener);
